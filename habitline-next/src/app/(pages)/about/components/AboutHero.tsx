    ...
    <section className="relative overflow-hidden pt-34 pb-15 md:pt-40 md:pb-25 lg:py-50">
      ...
      <div className="relative z-10 container mx-auto mb-15 lg:mb-32">
        <div className="mb-8 max-w-md lg:mb-20 lg:max-w-xl">
          <span className="border-default-200 text-ink mb-2 inline-block rounded-full border bg-white px-5 py-1 text-sm font-medium md:py-1.5 lg:mb-0">About the App</span>

          <h1 className="text-ink text-4xl font-medium tracking-tight md:text-[50px] lg:text-[90px]">A simpler way to build habits</h1>

          <div className="mt-2.5 flex flex-col items-start gap-5 md:mt-5 lg:mt-12 lg:flex-row lg:items-center lg:gap-7.5">
            <Link href="" className="group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-ink px-3.5 text-white shadow-xl! transition-all duration-300 hover:scale-95 lg:px-8.5">
            ...
            <div className="flex items-center gap-6">
              <div className="flex -space-x-2.5">
                ...
                <div className="border-default-800 bg-default-50 text-ink inline-flex size-10 items-center justify-center rounded-full border-2 text-[8px] font-bold shadow-sm">You?</div>
              </div>
      ...
      <div className="container">
        <div className="text-center">
          <span className="text-ink mb-5 block text-base lg:mb-7.5 lg:text-xl">Trusted worldwide</span>
        </div>
