    ...
    <section>
      <div className="container">
        <div className="lg:max-w-4xl">
          <h2 className="text-ink mb-3.75 text-2xl leading-tight font-medium tracking-tight lg:mb-5 lg:text-4xl">Most habit tools focus on streaks, pressure, and unrealistic expectations. Our mission is to create a system that works with real human behavior.</h2>
          <p className="text-ink max-w-2xl leading-relaxed lg:text-lg">
        ...
        <div className="mt-8 grid grid-cols-2 gap-2.5 md:mt-12 md:gap-7.5 lg:mt-12.5 lg:grid-cols-4">
          {missionData.map((item, idx) => (
            <div key={idx} className="group flex h-full flex-col justify-between gap-y-6.5 rounded-2xl bg-white p-3.5 md:gap-y-10 md:p-5 lg:gap-y-17.5 lg:p-7.5">
              ...
              <div>
                <h4 className="text-ink mb-2.5 text-xl font-medium md:text-2xl">{item.title}</h4>
