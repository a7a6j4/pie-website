      ...
      <div className="container">
        <div className="grid items-center gap-7.5 md:grid-cols-2 lg:gap-15">
          ...
          <div className="space-y-3.5 lg:space-y-5">
            <span className="border-default-200 text-ink inline-block rounded-full border bg-white px-5 py-1 text-sm font-medium md:py-1.5">Why Habitline Exists</span>

            <h2 className="text-ink mb-3.5 text-2xl leading-tight font-medium tracking-tight md:text-4xl lg:text-[50px]">Building habits shouldn’t feel overwhelming</h2>
