        ...
        <div className="grid grid-cols-1 items-center gap-7.5 lg:grid-cols-2 lg:gap-12">
          <div className="flex flex-col gap-y-5 lg:gap-y-12.5">
            <div className="space-y-4">
              <span className="border-default-200 text-ink inline-block rounded-full border bg-white px-5 py-1 text-sm font-medium md:py-1.5">Habitline in numbers</span>
              <h2 className="text-ink text-3xl leading-tight font-medium tracking-tight md:text-4xl lg:text-[50px]">
                Real habits, real
              ...
              {statsData.map((stat, idx) => (
                <div key={idx} className={`items-center gap-5 lg:flex lg:gap-7.5 ${stat.colSpanClass || ''}`}>
                  ...
                  <div className="text-center md:text-start">
                    <p className="text-ink mb-1.5 font-medium md:text-lg">{stat.title}</p>
          ...
          <div className="bg-default-200 relative flex flex-col items-center justify-between overflow-hidden rounded-2xl md:min-h-125 lg:min-h-150">
            <div className="z-10 pt-12.5 pb-12.5 text-center lg:pb-8">
              ...
              <span className="border-default-200 text-ink inline-block rounded-full border bg-white px-5 py-1 text-sm font-medium md:py-1.5">check-ins logged last month</span>
            </div>
