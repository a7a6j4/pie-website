        ...
        >
          ...
          <div className="relative z-10">
            <div className="mb-8 space-y-4 text-center md:mb-12 lg:mb-16">
              <span className="border-default-200 text-ink inline-block rounded-full border bg-white px-5 py-1 text-sm font-medium md:py-1.5">Our Team</span>
              <h2 className="text-ink text-2xl font-medium md:text-4xl lg:text-[50px]">
                The people who
                  ...
                  <div className="relative mx-auto overflow-hidden">
                    ...
                    <div className={`absolute inset-0 size-37.5 rounded-2xl bg-black/40 opacity-0 transition-opacity duration-500 group-hover:opacity-100 ${member.overlayClass || ''}`}>
                      <Link href={member.twitterUrl} target="_blank" className="absolute inset-s-1/2 bottom-5 flex size-9 -translate-1/2 translate-y-12 items-center justify-center rounded-full bg-white transition-transform duration-500 group-hover:translate-y-0">
                        <Icon icon="tabler:brand-x-filled" className="text-ink size-4" />
                      </Link>
                    </div>
                  </div>
            ...
            <div className="mx-auto mt-10 max-w-md space-y-5 text-center md:mt-12 lg:mt-19">
              <h3 className="text-ink text-xl leading-snug font-medium md:text-2xl">Be part of shaping systems that keep teams aligned and productive.</h3>
              <Link href="" className="group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-ink px-3.5 text-white shadow-xl! transition-all duration-300 hover:scale-95 md:px-8.5">
