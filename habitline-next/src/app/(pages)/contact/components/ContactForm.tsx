    ...
    <section className="pt-32.5 md:pt-36 lg:pt-50">
      <div className="container">
        <div className="mb-12 text-center lg:mb-20">
          <span className="border-default-200 text-ink inline-block rounded-full border bg-white px-5 py-1 text-sm font-medium md:py-1.5">Contact Us</span>

          <h1 className="text-ink my-2.5 text-4xl font-medium tracking-tight md:text-5xl lg:text-[90px]">We're here to help</h1>
            ...
            <form id="contact-form" className="space-y-3.5 md:space-y-8">
              <div className="grid grid-cols-1 gap-2.5 md:grid-cols-2 lg:gap-8">
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    required
                    className="bg-default-200/80 text-ink placeholder:text-default-600 w-full rounded-xl border-none px-5 py-4 transition-all focus:ring-2 focus:ring-slate-200 focus:outline-none"
                  />
                </div>
                <div className="flex flex-col">
              ...
              <div className="flex flex-col">
                ...
                <textarea
                  ...
                  className="bg-default-200/80 text-ink placeholder:text-default-600 w-full resize-none rounded-xl border-none px-5 py-4 transition-all focus:ring-2 focus:ring-slate-200 focus:outline-none"
                ></textarea>
              </div>

              <div className="pt-4">
                <button type="submit" className="bg-ink rounded-full px-8 py-4 font-medium text-white shadow-xl transition-all hover:scale-95">
                  Send message
                </button>
              </div>
            </form>
