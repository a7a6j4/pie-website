        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2">
            <div className="max-w-2xl">
              <h1 className="text-ink mb-5 text-3xl font-medium tracking-tight md:text-5xl lg:text-[68px]">Start building better habits today</h1>
              ...
              <div className="mb-5 flex gap-7.5 md:mb-7.5 lg:gap-20">
                <div>
                  <div className="flex items-baseline gap-1">
                    <h2 className="text-ink text-2xl font-medium md:text-3xl lg:text-4xl">32</h2>
                    <span className="text-ink text-2xl font-medium md:text-3xl lg:text-4xl">+</span>
                  </div>
                  <p className="text-default-600 mt-2 text-lg font-medium">Countries using Habitline</p>
                </div>
                <div>
                  <h2 className="text-ink text-2xl font-medium md:text-3xl lg:text-4xl">46</h2>
              ...
              <div className="mt-6.5 inline-flex items-center gap-5 rounded-2xl bg-white p-2 shadow-2xl md:mt-10 lg:mt-20">
                ...
                <div className="relative">
                  ...
                  <h3 className="text-ink mt-15 text-2xl leading-tight font-medium">
