        ...
        <div>
          <table className="w-full text-start">
            <thead className="bg-default-200 mb-10!">
              <tr>
                <th className="text-ink rounded-s-lg px-2 py-2.5 text-start text-sm font-medium md:p-5 md:text-xl lg:text-2xl">Features</th>
                <th className="px-2 py-2.5 text-center md:p-5">
                  <div className="text-ink text-sm font-medium md:text-xl lg:text-2xl">Free plan</div>
                  <div className="text-default-600 mt-1 text-xs font-medium md:text-lg">$0</div>
                </th>
                <th className="px-2 py-2.5 text-center md:p-5">
                  <div className="text-ink text-sm font-medium md:text-xl lg:text-2xl">Pro plan</div>
                ...
                <th className="rounded-r-2xl px-2 py-2.5 text-center md:p-5">
                  <div className="text-ink text-sm font-medium md:text-xl lg:text-2xl">Premium plan</div>
