    ...
    <section className="pt-32.5 md:pt-36 lg:pt-50">
      <div className="container">
        <div className="mb-7.5 text-center">
          <span className="border-default-200 text-ink inline-block rounded-full border bg-white px-5 py-1 text-sm font-medium md:py-1.5">Pricing plan</span>
          <h1 className="text-ink mt-2.5 text-3xl font-medium tracking-tight md:text-5xl lg:text-[68px]">Clear Plans for everyone</h1>

          <div className="mt-5 flex items-center justify-center gap-4 lg:mt-10">
            <span className="text-ink text-base font-medium md:text-lg">Monthly</span>
            ...
            <span className="text-ink text-base font-medium md:text-lg">Yearly</span>
          </div>
        </div>
              ...
              <div key={idx} className={`flex flex-col rounded-2xl bg-white p-3.5 shadow-xl md:p-5 lg:p-7.5 ${plan.colSpanClass || ''}`}>
                ...
                {price !== null && (
                  <div className="mb-2.5 flex items-baseline gap-2 lg:mb-5">
                    <p className="text-ink text-2xl font-semibold md:text-3xl lg:text-4xl">
                      $ <span>{price}</span>
                    </p>
                ...
                <div>
                  <Link href={plan.buttonLink} className="group bg-ink relative inline-flex items-center justify-center overflow-hidden rounded-full px-5 text-white shadow-xl! transition-all duration-300 hover:scale-95">
