        ...
        <div className="container">
          ...
          <div className="py-12 md:py-18 lg:py-25">
            <div className="mx-auto max-w-4xl">
              <div className="text-ink space-y-5 md:space-y-10">
                <div>
                  <h2 className="text-ink mb-2.5 text-xl font-medium md:text-2xl lg:text-4xl">Collecting Personal Information</h2>
                ...
                <div>
                  <h3 className="text-ink mb-2.5 text-xl font-semibold md:text-2xl lg:text-4xl">Sharing Personal Information</h3>
