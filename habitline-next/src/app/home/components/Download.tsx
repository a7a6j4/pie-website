...
import mobileImage from '@/assets/images/workspace/mobile-image01.png'
      ...
      <div className="relative z-10 container">
        <div className="grid grid-cols-1 items-center gap-7.5 md:grid-cols-3 md:gap-0">
          <div className="order-1 flex flex-col items-center text-center md:me-10 md:text-left lg:items-start">
            <h3 className="text-ink text-2xl font-medium tracking-tight lg:text-4xl">Make The Right Investment Decisions</h3>

            <p className="text-default-600 mt-2.5 text-lg lg:mt-5">Get real-time investment advice on the best opportunities for you and only you.</p>

            <div className="relative z-40 mt-3.5 flex flex-col gap-4 lg:mt-8">
              <Link href="" className="group relative inline-flex overflow-hidden rounded-full bg-ink px-3.5 text-white shadow-xl transition-all duration-300 hover:scale-95 lg:px-8.5">
              ...
              <Link href="" className="group bg-default-200 relative inline-flex overflow-hidden rounded-full px-3.5 text-ink transition-all duration-300 hover:scale-95 lg:px-8.5">
                <span className="relative flex flex-col items-center transition-transform duration-300 group-hover:-translate-y-full">
          ...
          <div className="order-2 flex flex-col items-center md:order-3 md:ms-10 lg:items-end">
            <div className="text-center md:text-start lg:max-w-xl">
              <h3 className="text-ink mb-5 text-2xl font-medium tracking-tight lg:text-4xl">Scan the QR code to download the app</h3>
