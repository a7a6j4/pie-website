              ...
              <div key={colIdx} className="space-y-3.5 md:space-y-5 lg:space-y-7.5">
                {column.map((item, itemIdx) => (
                  <div key={itemIdx} className="bg-default-200 flex flex-col justify-between rounded-2xl p-2.5 md:p-7.5">
                    <p className="text-ink mb-3.5 text-sm leading-snug font-medium md:mb-7.5 md:text-lg">{item.quote}</p>
                    <div className="flex items-center justify-between">
                      <div className="items-center gap-2.5 md:flex">
                        ...
                        <div className="mt-1.25 md:mt-0">
                          <h3 className="text-ink text-sm leading-none font-medium md:text-lg">{item.name}</h3>
                      ...
                      <Link href="" target="_blank" className="group inline-flex size-5.5 items-center justify-center overflow-hidden rounded-full bg-white md:size-10">
                        <span className="relative size-4 overflow-hidden">
                          <Icon icon="tabler:brand-x-filled" className="text-ink absolute inset-0 size-4 h-full w-full transition-transform duration-300 group-hover:-translate-y-[200%]" />
                          <Icon icon="tabler:brand-x-filled" className="text-ink absolute inset-0 size-4 h-full w-full translate-y-[200%] transition-transform duration-300 group-hover:translate-y-0" />
                        </span>
                      </Link>
                    </div>
                  </div>
