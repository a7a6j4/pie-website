...
import dashboard01 from '@/assets/images/workspace/dashboard-17.svg'
...
import dashboard04 from '@/assets/images/workspace/dashboard-14.svg'
import dashboard05 from '@/assets/images/workspace/dashboard-16.svg'
...
const Hero = () => {
  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-ink pt-34 md:pt-40 lg:pt-52">
      ...
      <div className="relative z-10 container mx-auto px-4" ref={videoRef}>
        <div className="flex flex-col items-center text-center">
          ...
          <div className="relative mt-6 flex w-full max-w-5xl items-start justify-center gap-8 md:mt-16 md:gap-5 lg:mt-20 lg:gap-10">
            ...
            <Image src={dashboard05} alt="Dashboard" className="relative -z-20! mt-34 h-144 w-75 md:mt-0 lg:w-90" />
            <Image src={dashboard04} alt="Dashboard" className="absolute inset-e-0 top-8 w-50 md:bottom-60 lg:inset-e-14 lg:w-60" />
          </div>
        </div>
      </div>
